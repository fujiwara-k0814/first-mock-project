...
<div class="address__content">
    ...
    <form action="/purchase/address/{{ $item->id }}" method="post" class="address-form">
        ...
        <div class="address-form__group">
            ...
            <input type="text" name="postal_code" id="postal_code" class="address-form__input" value="{{ old('postal_code', $deliveryAddress->postal_code) }}">
        ...
        <div class="address-form__group">
            ...
            <input type="text" name="address" id="address" class="address-form__input" value="{{ old('address', $deliveryAddress->address) }}">
            <div class="address-form__error">
                @error('address')
                    {{ $message }}
                @enderror
        ...
        <div class="address-form__group">
            ...
            <input type="text" name="building" id="building" class="address-form__input" value="{{ old('building', $deliveryAddress->building) }}">
            <div class="address-form__error">
                @error('building')
                    {{ $message }}
                @enderror
